<a
  ...
  {{
    $attributes->class([
      ...
      'hover:bg-green_dvr hover:border-green_dvr hover:text-white' => $variant === 'outline-primary',
      ...
      'bg-green_dvr border-green_dvr text-white hover:bg-opacity-80' => $variant === 'primary',
    ])
  }}
>
  {{$slot}}
