...
<section
  ...
  x-data="
        {
          selectedTab: 'all',
          activeClasses: 'bg-purple_dvr text-white',
          inactiveClasses: 'text-body-color hover:bg-purple_dvr hover:text-white',
        }
      "
    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full px-4">
        <div class="text-center mx-auto mb-[60px] max-w-[510px]">
          <h2 class="font-bold text-3xl sm:text-4xl md:text-[40px] text-gray-300 mb-4">
            My Projects
          </h2>
